...
class Media extends GObject.Object{
    ...
    _addPlayer(busName) {
        ...
        // console.log("4" + busName + " " + player);
        this._players.set(busName, player);
        // console.log(this._players);
        // console.log(this._players.get(busName));
        // this._sync();
    }
    ...
    _sync(){
        ...
        // console.log("SIZE " + this._players.size);
        if(this._players.size === 1)
            preferred = players[0];

        
        this._json.preferred = preferred;
        this._json.players = players;
